...
//    }
    ...
    public Result<List<Building>> getDormitoriesByRegion(@PathVariable("region") String region) {
        log.info("get dormitories by region");
...
//        boolean delete = teacherService.deleteRoomById(Long.parseLong(id));
    ...
    public Result<String> updateRoomById(@PathVariable("id") String id, @RequestBody Room room) {
        ...
        Room room1 = (Room) teacherService.updateRoom(room);
        return Result.success("success", null);
    }
    ...
    public Result<String> addRoom(@RequestBody Room room) {
        log.info("add room");
        Room room1 = (Room) teacherService.saveRoom(room);
        return Result.success("success", null);
    }
